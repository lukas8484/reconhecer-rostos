...
# Variável de filtro
frames_to_confirm = 75  # Ajuste este valor para mais precisão ou reatividade
...
while True:
    ...
    faceDetect = detectorFace.detectMultiScale(
        ...
        minNeighbors=5,     # Ajuste o número mínimo de vizinhos conforme necessário
    ...
    for (x, y, w, h) in faceDetect:
        ...
        if id not in last_log or {k: log_line[k] for k in log_line if k != 'confianca'} != {k: last_log[id][k] for k in log_line if k != 'confianca'}:
        ...
        cv2.rectangle(imagem, (x, y), (x + w, y + h), (0, 0, 255), 2)  # Retângulo em vermelho
